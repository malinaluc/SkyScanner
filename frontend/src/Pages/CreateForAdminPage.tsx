...
import { airlineTextField, budgetTextField, containerStyle, createAccountButtonStyle, createFlightButtonStyle, createUserButtonStyle, deleteUserFlightButtonStyle, emailTextField, logOutButtonStyle, nameTextField, pageStyle, passwordTextField, seeAllUsersButtonStyle, surnameTextField, updateUserFlightButtonStyle } from "./CreateForAdminPage.styles";
    ...
    return (
        <div style={pageStyle}>
            ...
            {createFlightContainer && ( 
                <div style={{ textAlign: 'center', marginTop: '50px' }}>
                    <TextField id = "airlineTextField" label ="Airline" variant = "outlined" size ="medium" style = {airlineTextField} ></TextField>
                    <div style={containerStyle}>
                    <TextField id = "airlineTextField" label ="Airline" variant = "outlined" size ="medium" style = {airlineTextField} ></TextField>
